...
@interface AddNewInspectRecordViewController : UIViewController<InspectionPickerDelegate,DatetimePickerHandler,UITextFieldDelegate,RoadSegmentPickerDelegate,UserPickerDelegate>
...
@property (weak, nonatomic) IBOutlet UIButton *addControlBoxBtn;
@property (weak, nonatomic) IBOutlet UIButton *addStreetLampBtn;
