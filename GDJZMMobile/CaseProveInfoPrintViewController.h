...
@interface CaseProveInfoPrintViewController : CasePrintViewController <DatetimePickerHandler, UserPickerDelegate,AutoNumberPickerDelegate>
...
@property (weak, nonatomic) IBOutlet UITextField *textprover3;//勘查人3
@property (weak, nonatomic) IBOutlet UITextField *textprover3_duty;

@property (nonatomic, weak) IBOutlet UITextField *textcitizen_name;//单行多文本框    当事人
@property (nonatomic, weak) IBOutlet UITextField *textcitizen_duty;//单行多文本框    当事人单位

@property (nonatomic, weak) IBOutlet UITextField *textparty;//单行多文本框   性别
@property (nonatomic, weak) IBOutlet UITextField *textparty_org_duty;//单行多文本框    身份证号
...
@property (weak, nonatomic) IBOutlet UITextField *textAge; //当事人年龄
@property (weak, nonatomic) IBOutlet UITextField *textPhoneNumber;  //当事人联系电话
@property (weak, nonatomic) IBOutlet UITextField *textAddress;  //当事人住址
@property (weak, nonatomic) IBOutlet UITextField *textDuty; //  当事人职务
